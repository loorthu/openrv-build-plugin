...
5. List the remaining `manual-only` items with their `install_hint` and a pointer to `platforms/<os>.md`. Do not attempt to perform manual steps in this command — `/openrv:build` does that interactively.
